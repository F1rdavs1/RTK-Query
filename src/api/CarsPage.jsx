...
import { useGetCarsQuery, useAddCarMutation, useDeleteCarMutation, useUpdateCarMutation } from './apiSlice';
...
const CarsPage = () => {
  ...
  return (
    <div>
      ...
      <input value={newCar} onChange={(e) => setNewCar(e.target.value)} placeholder="A new car" />
